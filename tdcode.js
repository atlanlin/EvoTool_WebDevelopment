(function(window) {
	...
	function roiSet() {
		...
		if (document.getElementById("defineWindow").checked) {
			...
			ajaxGet('any.htm?cmd=%23021%3BEVO%20DataCode%3B1%3BSourceWindow.SourceWindow.Left%3B'+$("#xValue").val()+'%23');
			ajaxGet('any.htm?cmd=%23021%3BEVO%20DataCode%3B1%3BSourceWindow.SourceWindow.Top%3B'+$("#yValue").val()+'%23');
			ajaxGet('any.htm?cmd=%23021%3BEVO%20DataCode%3B1%3BSourceWindow.SourceWindow.Width%3B'+$("#wValue").val()+'%23');
			ajaxGet('any.htm?cmd=%23021%3BEVO%20DataCode%3B1%3BSourceWindow.SourceWindow.Height%3B'+$("#hValue").val()+'%23');
		}
	}
